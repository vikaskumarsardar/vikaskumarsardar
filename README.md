...
<p align="center">
  ...
  <a href="https://github.com/vikaskumarsardar">
    <img src="https://img.shields.io/badge/Domain-Observability_%26_Distributed_Systems-8a2be2?style=for-the-badge" />
  </a>
...
Senior Full Stack & Backend Systems Engineer specializing in high-throughput backend architectures, payment processing engines, responsive React/Next.js platforms, and real-time observability tooling. Experienced across:
* **Full Stack & Modern Web Applications**: Engineered responsive **React (SPA)** and **Next.js (App Router)** customer and partner portals with **Tailwind CSS**, **Redux Toolkit**, and **TypeScript**.
